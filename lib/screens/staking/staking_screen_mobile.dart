...
class StakingScreenMobile extends StatefulWidget {
  const StakingScreenMobile({Key? key}) : super(key: key);

  @override
  State<StakingScreenMobile> createState() => _StakingState();
}

class _StakingState extends State<StakingScreenMobile> {
