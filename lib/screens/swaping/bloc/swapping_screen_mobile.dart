...
class SwapScreenMobile extends StatefulWidget {
  const SwapScreenMobile({Key? key}) : super(key: key);

  @override
  State<SwapScreenMobile> createState() => _SwapScreenState();
}

class _SwapScreenState extends State<SwapScreenMobile> {
